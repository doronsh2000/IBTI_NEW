...
// if(   (last_green_bar_open > marketData[0].close[marketData[0].close.length-1]) && take_profit_signal=='BUY'  ){
 ...
 if(   (last_green_bar_open > marketData[0].close[marketData[0].close.length-1]) && take_profit_signal=='BUY'  ){
         ...
         console.log('exiting LONG!!- CAD');
          fs.appendFileSync('./signals.txt','exiting LONG!!- CAD' + new Date() + ' \n');
...
var event=new RedisEvent('localhost',['forex_buy_and_sell']);
 ...
 //if( (  last_red_bar_open < marketData[0].close[marketData[0].close.length-1]) && take_profit_signal=='SELL' ){
  ...
  if( (  last_red_bar_open < marketData[0].close[marketData[0].close.length-1]) && take_profit_signal=='SELL' ){
          ...
          console.log('exiting SHORT!! - CAD');
          fs.appendFileSync('./signals.txt','exiting SHORT!! - CAD' + new Date() + '\n');
var event=new RedisEvent('localhost',['forex_buy_and_sell']);
        event.on('ready',function(){
           event.pub('forex_buy_and_sell:app',{
...
talib.execute({
    ...
    console.log('current CAD high is: ' +  marketData[0].high[marketData[0].high.length-1]);
    console.log('current CAD low is: ' +  marketData[0].low[marketData[0].low.length-1]);
...
//    if (  marketData[0].close[marketData[0].close.length-1] -  marketData[0].open[marketData[0].open.length-2] > 0  && ( current_rsi_1m_level <40 || current_rsi_1m_level  > 60)  && take_profit_signal=='') {
    ...
    if (  marketData[0].close[marketData[0].close.length-1] -  marketData[0].open[marketData[0].open.length-2] > 0  && (   marketData[0].close[marketData[0].close.length-1] -  marketData[0].open[marketData[0].open.length-1] > 0 &&   marketData[0].open[marketData[0].open.length-2] -  marketData[0].close[marketData[0].close.length-2] > 0)  && take_profit_signal=='') {
...
// if (  marketData[0].open[marketData[0].open.length-2] - marketData[0].close[marketData[0].close.length-1] > 0 &&  ( current_rsi_1m_level>60 || current_rsi_1m_level <40)  &&  take_profit_signal=='' ){
 ...
 if (  marketData[0].close[marketData[0].close.length-1] - marketData[0].open[marketData[0].open.length-2] < 0 &&  ( marketData[0].close[marketData[0].close.length-2] - marketData[0].open[marketData[0].open.length-2] > 0 &&  marketData[0].open[marketData[0].open.length-1] - marketData[0].close[marketData[0].close.length-1] > 0)  &&  take_profit_signal=='' ){
